...
ALLOWED_FUNCTIONS = {
    ...
    "mysql": {
        "sum", "count", "avg", "min", "max",
        "coalesce", "nullif", "round", "cast", "ifnull",
        "lower", "upper", "trim", "length", "substring",
        "left", "right", "concat", "replace",
        "abs", "floor", "ceil",
    ...
    "sqlserver": {
        "sum", "count", "avg", "min", "max",
        "coalesce", "nullif", "round", "cast", "convert", "isnull",
        "lower", "upper", "trim", "length", "len", "substring",
        "left", "right", "concat", "replace", "charindex",
        "abs", "floor", "ceil", "ceiling",
        "getdate", "current_timestamp",
        "dateadd", "date_add", "datediff", "datepart", "extract",
        "datename", "year", "month", "day", "format",
        # sqlglot canonical names for FORMAT/DATENAME/DATEDIFF transforms
        "time_to_str", "time_str_to_time",
        "case", "lag", "lead", "row_number", "rank", "dense_rank",
        "over", "partition",
    },
}
